    ...
    >
      ...
      <div id="social-proof" data-section="social-proof">
        <SocialProofOne
          ...
          names={[
            "TechVentures Spain",            "FinanceHub Madrid",            "LegalPro Consultancy",            "ManufacturePlus",            "RetailConnect",            "InnovateCorp",            "GrowthPartners"]}
          speed={40}
          showCard={true}
        />
      </div>
      ...
      <div id="services" data-section="services">
        <FeatureCardTwentySeven
          ...
          features={[
            {
              id: "business-advisory",              title: "Business Advisory",              descriptions: [
                "Strategic growth planning tailored to your market position",                "Business structure optimization for tax efficiency",                "Market entry and expansion strategies"],
              imageSrc:
                "http://img.b2bpic.net/free-photo/busy-multicultural-diverse-employees-analysing-annual-financial-statistics-sitting-desk-front-laptop-holding-documents-searching-business-solutions-team-businesspeople-working-company_482257-13550.jpg",              imageAlt: "Business Advisory Services"},
            {
                ...
                "http://img.b2bpic.net/free-photo/handsome-young-man-working-with-digital-tablet-office_1301-7623.jpg?_wi=1",              imageAlt: "Legal Compliance Services"},
            {
              ...
              imageSrc:
                "http://img.b2bpic.net/free-photo/person-office-analyzing-checking-finance-graphs_23-2150377136.jpg",              imageAlt: "Financial Consulting Services"},
            {
      ...
      <div id="about" data-section="about">
        <SplitAbout
          ...
          bulletPoints={[
            {
              title: "Multidisciplinary Excellence",              description:
                "Economists, lawyers, and business professionals working in harmony to solve complex challenges",              icon: Users,
            },
            {
              title: "Efficiency First",              description:
                "Fast, impeccable service that respects your time and budget constraints",              icon: Zap,
            },
            {
              title: "Trusted Advisors",              description:
                "Long-term partnerships built on transparency, expertise, and proven results",              icon: Shield,
            },
            {
              title: "Problem Solving",              description:
      ...
      <div id="metrics" data-section="metrics">
        <MetricCardSeven
          ...
          metrics={[
            {
              id: "1",              value: "200+",              title: "Businesses Guided",              items: [
                "Diverse industries and sectors",                "SMEs and startups",                "Strategic growth achieved"],
            },
            {
              id: "2",              value: "15+",              title: "Years Excellence",              items: [
                "Established track record",                "Market expertise",                "Client retention 95%+"],
            },
            {
              id: "3",              value: "98%",              title: "Client Satisfaction",              items: [
                "Exceptional results",                "Professional service",                "Highly recommended"],
            },
            {
              id: "4",              value: "8+",              title: "Industries Served",              items: [
                "Technology sector",                "Financial services",                "Manufacturing and retail"],
            },
          ]}
        />
      </div>
      ...
      <div id="team" data-section="team">
        <TeamCardEleven
          ...
          groups={[
            {
              id: "global",              groupTitle: "Senior Partners",              members: [
                {
                  id: "1",                  title: "María García López",                  subtitle: "Managing Partner, Business Strategy",                  detail: "20+ years advising Spanish enterprises",                  imageSrc:
                    "http://img.b2bpic.net/free-photo/medium-shot-woman-sitting-couch_23-2149915934.jpg",                  imageAlt: "María García López"},
                {
                  id: "2",                  title: "Carlos Fernández Martinez",                  subtitle: "Senior Advisor, Legal Compliance",                  detail: "Legal expert in regulatory frameworks",                  imageSrc:
                    "http://img.b2bpic.net/free-photo/successful-expert_1098-14503.jpg",                  imageAlt: "Carlos Fernández Martinez"},
                {
                  id: "3",                  title: "Dr. Javier Ruiz Sánchez",                  subtitle: "Financial Consultant, Chief Economist",                  detail: "Advanced economics and financial planning",                  imageSrc:
                    "http://img.b2bpic.net/free-photo/thoughtful-blond-business-woman-sitting-couch_23-2148095700.jpg",                  imageAlt: "Dr. Javier Ruiz Sánchez"},
              ],
            },
          ]}
        />
          ...
          testimonials={[
                ...
                "http://img.b2bpic.net/free-photo/portrait-confident-businessman_107420-84879.jpg?_wi=1",              imageAlt: "Miguel Gonzalez"},
            {
              id: "3",              name: "Elena Rodríguez",              handle: "Director, Retail Network",              testimonial:
                ...
                "http://img.b2bpic.net/free-photo/shot-beautiful-young-businesswoman-wearing-blue-chiffon-shirt-while-standing-building-street-with-folded-arms_158595-6642.jpg",              imageAlt: "Elena Rodríguez"},
            {
              id: "4",              name: "Jorge López",              handle: "Owner, Family Business",              testimonial:
                "Highly professional, efficient team that resolves issues quickly. We've worked with them for 5+ years with consistent excellence.",              imageSrc:
                "http://img.b2bpic.net/free-photo/portrait-confident-senior-businessman-office_1262-2396.jpg",              imageAlt: "Jorge López"},
            {
      ...
      <div id="cta" data-section="cta">
        <SplitAbout
          ...
          bulletPoints={[
            {
              title: "Free Initial Assessment",              description:
                "30-minute consultation to understand your challenges and potential solutions",              icon: Clock,
            },
            {
              title: "No Long-term Commitment",              description:
                "Flexible engagement models tailored to your specific needs and timeline",              icon: FileCheck,
            },
            {
              title: "Confidential & Professional",              description:
        ...
        <ContactSplitForm
          ...
          textarea={{
            name: "message",            placeholder:
              "Describe your business challenge or inquiry. What would you like to discuss with our team?",            rows: 6,
            required: true,
          }}
          useInvertedBackground={true}
